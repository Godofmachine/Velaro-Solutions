...
<section class="py-24 bg-neutral-light dark:bg-neutral-dark border-b border-gray-200 dark:border-slate-800 transition-colors duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center reveal-hidden">
        <h1 class="text-4xl md:text-5xl font-serif font-bold text-primary dark:text-white mb-6" data-i18n="services_title"><?php echo t('services_title'); ?></h1>
        <p class="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto font-light" data-i18n="services_subtitle"><?php echo t('services_subtitle'); ?></p>
    </div>
</section>
