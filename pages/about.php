...
<section class="py-20 bg-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center reveal-hidden">
        ...
        <p class="text-lg text-gray-600 leading-relaxed delay-100 reveal-hidden">
...
<section class="py-20 bg-neutral-light border-t border-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 max-w-5xl mx-auto">
            <!-- Team Member 1 -->
            <div class="bg-white rounded-3xl overflow-hidden shadow-sm hover-lift group text-center pb-8 border border-gray-100 reveal-hidden delay-100">
                <div class="h-64 overflow-hidden mb-6 relative">
                    <img src="https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=800&q=80" alt="Michael Bauer" class="w-full h-full object-cover group-hover:scale-105 transition duration-700" />
            ...
            <!-- Team Member 2 -->
            <div class="bg-white rounded-3xl overflow-hidden shadow-sm hover-lift group text-center pb-8 border border-gray-100 reveal-hidden delay-200">
                <div class="h-64 overflow-hidden mb-6 relative">
                    <img src="https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?auto=format&fit=crop&w=800&q=80" alt="Sarah Schmidt" class="w-full h-full object-cover group-hover:scale-105 transition duration-700" />
                    <div class="absolute inset-0 bg-primary/10 group-hover:bg-transparent transition"></div>
                </div>
            ...
            <!-- Team Member 3 -->
            <div class="bg-white rounded-3xl overflow-hidden shadow-sm hover-lift group text-center pb-8 border border-gray-100 reveal-hidden delay-300">
                <div class="h-64 overflow-hidden mb-6 relative">
                    <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=800&q=80" alt="Lukas Meyer" class="w-full h-full object-cover group-hover:scale-105 transition duration-700" />
                    <div class="absolute inset-0 bg-primary/10 group-hover:bg-transparent transition"></div>
                </div>
